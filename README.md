...
<p align="center">
  ...
  <a href="https://sourcegraph.com/github.com/renlforreal/webrtc?badge"><img src="https://sourcegraph.com/github.com/renlforreal/webrtc/-/badge.svg" alt="Sourcegraph Widget"></a>
  ...
  <a href="https://pkg.go.dev/github.com/renlforreal/webrtc/v3"><img src="https://pkg.go.dev/badge/github.com/renlforreal/webrtc/v3.svg" alt="Go Reference"></a>
  ...
  <a href="https://goreportcard.com/report/github.com/renlforreal/webrtc/v3"><img src="https://goreportcard.com/badge/github.com/renlforreal/webrtc/v3" alt="Go Report Card"></a>
...
**[GoDoc](https://pkg.go.dev/github.com/renlforreal/webrtc/v3)** is an auto generated API reference. All our Public APIs are commented.

**[FAQ](https://github.com/renlforreal/webrtc/wiki/FAQ)** has answers to common questions. If you have a question not covered please ask in [Slack](https://pion.ly/slack) we are always looking to expand it.
...
Join our [Office Hours](https://github.com/renlforreal/webrtc/wiki/OfficeHours). Come hang out, ask questions, get help debugging and
...
* [SettingEngine](https://pkg.go.dev/github.com/renlforreal/webrtc/v3#SettingEngine) for Pion specific extensions
...
* [Simulcast](https://github.com/renlforreal/webrtc/tree/master/examples/simulcast)
* [SVC](https://github.com/pion/rtp/blob/master/codecs/vp9_packet.go#L138)
* [NACK](https://github.com/renlforreal/interceptor/pull/4)
* [Sender/Receiver Reports](https://github.com/renlforreal/interceptor/tree/master/pkg/report)
* [Transport Wide Congestion Control Feedback](https://github.com/renlforreal/interceptor/tree/master/pkg/twcc)
* [Bandwidth Estimation](https://github.com/renlforreal/webrtc/tree/master/examples/bandwidth-estimation-from-disk)
...
* Wide platform support
  ...
  * iOS, Android
  * [WASM](https://github.com/renlforreal/webrtc/wiki/WebAssembly-Development-and-Testing) see [examples](examples/README.md#webassembly)
...
The library is in active development, please refer to the [roadmap](https://github.com/renlforreal/webrtc/issues/9) to track our major milestones.
We also maintain a list of [Big Ideas](https://github.com/renlforreal/webrtc/wiki/Big-Ideas) these are things we want to build but don't have a clear plan or the resources yet.
...
Check out the [contributing wiki](https://github.com/renlforreal/webrtc/wiki/Contributing) to join the group of amazing people making this project possible: [AUTHORS.txt](./AUTHORS.txt)
